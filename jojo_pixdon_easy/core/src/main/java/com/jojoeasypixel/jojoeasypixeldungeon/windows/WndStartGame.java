...
import com.jojoeasypixel.jojoeasypixeldungeon.scenes.IntroScene;
				...
				if (cl != null) {
					...
					switch(cl){
						...
						case MAGE:
							...
							break;
						case ROGUE:
							heroItem.icon(new ItemSprite(ItemSpriteSheet.ARTIFACT_METALICA, null));
						...
						case HUNTRESS:
							...
							heroLoadout.icon(new ItemSprite(ItemSpriteSheet.ARTIFACT_SLOWDANCER, null));
