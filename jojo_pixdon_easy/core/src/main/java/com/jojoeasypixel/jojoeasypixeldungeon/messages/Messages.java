...
package com.jojoeasypixel.jojoeasypixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.actors.actors",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.items.items",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.journal.journal",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.levels.levels",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.plants.plants",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.scenes.scenes",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.ui.ui",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.windows.windows",
			"com.jojoeasypixel.jojoeasypixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.jojoeasypixel.jojoeasypixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
