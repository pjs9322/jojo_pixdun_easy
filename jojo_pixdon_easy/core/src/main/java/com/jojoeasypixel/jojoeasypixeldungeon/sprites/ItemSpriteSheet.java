...
public class ItemSpriteSheet {
	...
	public static final int ARTIFACT_METALICA   = ARTIFACTS+23;
	public static final int ARTIFACT_SLOWDANCER = ARTIFACTS+24;
	static{
		...
		assignItemRect(ARTIFACT_METALICA,	  14, 14);
		assignItemRect(ARTIFACT_SLOWDANCER, 14, 14);
	}
