...
import com.jojoeasypixel.jojoeasypixeldungeon.sprites.MissileSprite;
...
public class SpiritBow extends Weapon {
	...
	public int min(int lvl) {
		return 1 + Dungeon.hero.lvl/3 + RingOfSharpshooting.levelDamageBonus(Dungeon.hero);
	}
	
	@Override
	public int max(int lvl) {
		return 6 + (int)(Dungeon.hero.lvl/1.5f) + 2*RingOfSharpshooting.levelDamageBonus(Dungeon.hero);
	}
