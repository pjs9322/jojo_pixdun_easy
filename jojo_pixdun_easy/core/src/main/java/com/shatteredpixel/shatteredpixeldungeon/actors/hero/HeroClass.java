...
import com.shatteredpixel.shatteredpixeldungeon.items.wands._HeavensDoor;
...
public enum HeroClass {
	...
	private static void initMage( Hero hero ) {
		...
		staff = new MagesStaff(new _HeavensDoor());
	...
	private static void initHuntress( Hero hero ) {
		...
		_SlowDancer rose = new _SlowDancer();
